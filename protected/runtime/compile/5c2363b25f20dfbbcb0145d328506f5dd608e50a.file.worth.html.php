<?php /* Smarty version Smarty-3.1.18, created on 2015-09-28 14:41:44
         compiled from "/home/work/websites/tuan/protected/views/manual/worth.html" */ ?>
<?php /*%%SmartyHeaderCode:16925858415608e128cd6859-09860284%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c2363b25f20dfbbcb0145d328506f5dd608e50a' => 
    array (
      0 => '/home/work/websites/tuan/protected/views/manual/worth.html',
      1 => 1439888338,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16925858415608e128cd6859-09860284',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5608e128d44e55_36418631',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5608e128d44e55_36418631')) {function content_5608e128d44e55_36418631($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("layouts/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
"  data-date-format="yyyy-mm-dd">
                    ...
                    <div class="form-group">
                        ...
                        <select style="width:172px" class="form-control" name="type" id="type">
                            <option value='1' <?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>selected<?php }?>>已到超值团购</option>
                            <option value='2' <?php if ($_smarty_tpl->tpl_vars['type']->value==2) {?>selected<?php }?>>未到超值团购</option>
                        </select>
                    </div>
                    <button id="submit" class="btn btn-default">查看</button>
                    <?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>
                      <button id="saveGoodsSort" data-db='home' type="button" class="pull-right btn btn-default">保存排序</button>
                    <?php } else { ?>
                      <button id="saveGoods" data-db='home' type="button" class="pull-right btn btn-default">保存</button>
                    <?php }?>
                </form>
            </div>
        </div>
...
">详情</a>
 ...
 role="button" class="selecteBox select-box btn btn-default pull-right">选定</a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>
                        <a data-gid=<?php echo $_smarty_tpl->tpl_vars['item']->value['gid'];?>
 data-db='home' role="button" class="deleteBox delete-box btn btn-danger pull-right">删除</a>
                        <?php }?>
                    </p>
                </div>
            </div>
