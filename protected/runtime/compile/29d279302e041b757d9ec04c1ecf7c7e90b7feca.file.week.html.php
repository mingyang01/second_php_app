<?php /* Smarty version Smarty-3.1.18, created on 2015-09-28 14:41:43
         compiled from "/home/work/websites/tuan/protected/views/manual/week.html" */ ?>
<?php /*%%SmartyHeaderCode:20743434855608e12764bce6-64602929%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29d279302e041b757d9ec04c1ecf7c7e90b7feca' => 
    array (
      0 => '/home/work/websites/tuan/protected/views/manual/week.html',
      1 => 1439888338,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20743434855608e12764bce6-64602929',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5608e1276dca31_19411360',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5608e1276dca31_19411360')) {function content_5608e1276dca31_19411360($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("layouts/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
"  data-date-format="yyyy-mm-dd">
                    ...
                    <div class="form-group">
                        ...
                        <select style="width:172px" class="form-control" name="type" id="type">
                            <option value='1' <?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>selected<?php }?>>已到本周精选</option>
                            <option value='2' <?php if ($_smarty_tpl->tpl_vars['type']->value==2) {?>selected<?php }?>>未到本周精选</option>
                        </select>
                    </div>
...
">详情</a>
 ...
 role="button" class="selecteBox select-box btn btn-default pull-right">选定</a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>
                        <a data-gid=<?php echo $_smarty_tpl->tpl_vars['item']->value['gid'];?>
 data-db='week' role="button" class="deleteBox delete-box btn btn-danger pull-right">删除</a>
                        <?php }?>
                    </p>
                </div>
            </div>
