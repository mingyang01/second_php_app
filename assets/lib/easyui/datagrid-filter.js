		...
		function initCss(){
			if (!$('#datagrid-filter-style').length){
				$('head').append(
					...
					'a.datagrid-filter-btn{display:inline-block;padding-left:8px;line-height:22px;width:22px;height:22px;margin:0;vertical-align:top;cursor:pointer;opacity:0.6;filter:alpha(opacity=60);}' +
