...
(function () {
  ...
  //  URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
     ...
     */
    // URL = '/app/messageManage/ueditor/';
    window.UEDITOR_CONFIG = {

        //为编辑器实例添加一个路径，这个不能被注释
        UEDITOR_HOME_URL : '/assets/lib/ueditor/'

        //图片上传配置区
        ,imageUrl:'/base/uEditorImgUp'             //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //附件上传配置区
        ,fileUrl:"/base/uEditorImageManage"               //附件上传提交地址
...
/*         //远程抓取配置区
        ...
        //图片在线管理配置区
        ,imageManagerUrl: "/base/uEditorImageManage"           //图片在线管理的处理地址
        ,imageManagerPath:""                         //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: '/base/uEditorImgUp'  //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath:""
      ...
      //  ,getMovieUrl:URL+"php/getMovie.php"                   //视频数据获取地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'insertvideo','music', 'map', 'gmap', 'insertframe','highlightcode','pagebreak','template', '|',
