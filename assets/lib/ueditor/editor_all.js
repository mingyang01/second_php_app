...
(function (){
    ...
    ColorPicker.prototype = {
        ...
        _onTableClick: function (evt){
            ...
            if (color && color == "UeditorHandColor"){
            	color = $("#UeditorHandColor").val();
            }
    ...
    var COLORS = (
            'ffffff,000000,eeece1,1f497d,4f81bd,c0504d,9bbb59,8064a2,4bacc6,FF6699,' +
            'f2f2f2,7f7f7f,ddd9c3,c6d9f0,dbe5f1,f2dcdb,ebf1dd,e5e0ec,dbeef3,FEC7D9,' +
            'd8d8d8,595959,c4bd97,8db3e2,b8cce4,e5b9b7,d7e3bc,ccc1d9,b7dde8,FEA8C5,' +
            'bfbfbf,3f3f3f,938953,548dd4,95b3d7,d99694,c3d69b,b2a2c7,92cddc,FE8AB0,' +
            'a5a5a5,262626,494429,17365d,366092,953734,76923c,5f497a,31859b,FF6699,' +
            '7f7f7f,0c0c0c,1d1b10,0f243e,244061,632423,4f6128,3f3151,205867,FD1A66,' +
            'c00000,ff0000,ffc000,ffff00,92d050,00b050,00b0f0,0070c0,002060,FF6699,').split(',');

    function genColorPicker(noColorText,editor){
        var html = '<div id="##" class="edui-colorpicker %%">' +
            '<div class="edui-colorpicker-topbar edui-clearfix">' +
            '<span><input style="border:1px solid #ccc;width:122px;height:15px;margin:0px 10px 3px 0px;" data-color="UeditorHandColor" onblur="$$._onTableOver(event, this);" type="text" name="UeditorHandColor" id="UeditorHandColor" /><input style="border: 1px solid #333333;cursor: pointer; font-size: 12px; color:#333; line-height: 14px; margin-right: 1px;padding:0;heigt:14px; " type="button" data-color="UeditorHandColor" onclick="return $$._onTableClick(event, this);" value="应用"></span>' +
